...
final class TestCalendar extends TestCase
{

    // toute fonction qui commence par "test" est considérée être un test.
    function testEstBissextile()
    {
        $this->assertTrue(Calendar::estBissextile(2000));
        $this->assertTrue(Calendar::estBissextile(2020));

        $this->assertFalse(Calendar::estBissextile(2001));
        $this->assertFalse(Calendar::estBissextile(2100));
    }
    ...
    function testNombreJours()
    {
        ...
        for ($i = 0; $i < count($nbJoursNormal); $i++) {
            $mois = 1 + $i;
            $this->assertSame($nbJoursNormal[$i], Calendar::nombreJours($mois, $année));
        }
        ...
        for ($i = 0; $i < count($nbJoursBissextile); $i++) {
            $mois = 1 + $i;
            $this->assertSame($nbJoursBissextile[$i], Calendar::nombreJours($mois, $année));
        }
    }
    ...
    {
        $this->assertSame($expected, Calendar::numéroJour($jour, $mois, $année));
    }
